...
export default function EShopRegister({ businessTypes, subscriptionPlans }) {
    ...
    const renderACSCredentials = () => (
        <div className="space-y-6">
            <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900">ACS API Configuration</h2>
                <p className="mt-2 text-gray-600">Configure your ACS Courier integration (Optional - can be done later)</p>
            </div>
                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-blue-700">
                            <p>You can use "demo" for all fields to test the system, or add your real ACS credentials now.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <TextInput
                        ...
                        placeholder="demo"
                    />
                    <InputError message={errors.acs_api_key} className="mt-2" />
                </div>
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        placeholder="demo"
                    />
                    <InputError message={errors.acs_company_id} className="mt-2" />
                </div>
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        placeholder="demo"
                    />
                    <InputError message={errors.acs_company_password} className="mt-2" />
                </div>
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        placeholder="demo"
                    />
                    <InputError message={errors.acs_user_id} className="mt-2" />
                </div>
                ...
                <div className="md:col-span-2">
                    ...
                    <TextInput
                        ...
                        placeholder="demo"
                    />
                    <InputError message={errors.acs_user_password} className="mt-2" />
                </div>
            </div>
        </div>
    );
    ...
    const steps = [
        ...
        { number: 5, title: 'ACS Integration', component: renderACSCredentials },
        { number: 6, title: 'Terms & Conditions', component: renderTerms },
    ];
