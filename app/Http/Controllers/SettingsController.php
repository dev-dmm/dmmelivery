        ...
        return Inertia::render('Settings/Index', [
            ...
            'courier_options' => [
                'acs' => [
                    ...
                    'description' => 'Ελληνική υπηρεσία μεταφορών με παρακολούθηση σε πραγματικό χρόνο (διαμορφωμένη μέσω plugin WordPress)',
                ],
                'speedex' => [
                    'name' => 'Speedex',
                    'logo' => '📦',
                    'status' => 'managed_via_wordpress',
                    'description' => 'Γρήγορη υπηρεσία παράδοσης (διαμορφωμένη μέσω plugin WordPress)',
                ],
                'elta' => [
                    'name' => 'ΕΛΤΑ Courier',
                    'logo' => '📮',
                    'status' => 'managed_via_wordpress',
                    'description' => 'Ελληνική ταχυδρομική υπηρεσία (διαμορφωμένη μέσω plugin WordPress)',
                ],
                'geniki' => [
                    'name' => 'Geniki Taxydromiki',
                    'logo' => '🚛',
                    'status' => 'managed_via_wordpress',
                    'description' => 'Υπηρεσία γρήγορης παράδοσης (διαμορφωμένη μέσω plugin WordPress)',
                ],
            ],
